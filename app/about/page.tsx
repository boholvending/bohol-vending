...
export default function AboutPage() {
  ...
  return <SiteShell>
    ...
    <main className={s.page}>
      ...
      <section className={s.credentials} id="credentials"><div className={s.sectionHead}><h2>Quality you can see.</h2><p>Review our company credentials and discuss the documentation required for your machine and destination market.</p></div><a className={s.certificate} href="/images/bohol-certification-banner.webp" target="_blank" rel="noreferrer"><Image src="/images/bohol-certification-banner.webp" alt="BOHOL company certificates and qualifications" width={2172} height={724} sizes="100vw"/><span>View certificates at full size <ArrowUpRight size={17}/></span></a><div className={s.documentLinks}><span>Quality management</span><span>Product conformity</span><span>Company qualifications</span><Link href="/contact">Request documentation <ArrowUpRight size={17}/></Link></div></section>
