  ...
  return (
    <section id="credentials" className={styles.section}>
      ...
      <div className={styles.certificateBanner}>
        <Image src="/images/bohol-certification-banner.png" alt="BOHOL certifications and quality credentials" fill sizes="(max-width: 900px) 100vw, 1480px" />
      </div>
      <div id="partnerships" className={styles.partners}>
        ...
        <div className={styles.partnerGrid}>
          {[
            ...
            { title: "Deliver repeatable quality.", label: "For integration partners", image: "/images/partnerships/bohol-production.png", href: "/oem-odm", description: "Consistent output across every production run", position: "50% 50%" },
