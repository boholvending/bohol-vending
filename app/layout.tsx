...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="en" className={`${manrope.variable} ${space.variable}`}><body><EnquirySource/><LazyContactFloat/><JsonLd data={organizationJsonLd}/><GoogleAnalytics/>{children}</body></html>}
